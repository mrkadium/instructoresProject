...
<body>        
    <main>
        <div class="fondo">
            <div class="header">
                <h1>Selección de catedrático</h1>
                <form action="">
    ...
    <script>
        function _Seleccionar_(row){
            var idcatedratico = row.cells[0].innerHTML;
            var catedratico = row.cells[2].innerHTML;
            window.opener.setDataCatedratico(idcatedratico, catedratico);
            window.close();
        }
    </script>
</body>
