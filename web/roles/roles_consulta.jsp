    ...
    <div class="fondo">
        <!--<div class="conf">-->
            <div class="header">
                ...
                <a class="add_record" href="${pageContext.servletContext.contextPath}/Roles?accion=insertar"><i class="fas fa-plus-circle"></i> Agregar</a>
            </div>
            <div class="results">
                ...
                <div class="results__pagination">
                    <p>Página</p>
                    <button class="prev" onclick="abrirVentana('${pageContext.servletContext.contextPath}/Roles?pag_number=${pag.getPrevPage()}')">&lt;</button>
                    <span>${pag.getCurrentPage()}/${pag.getTotalPages()}</span>
                    <button class="next" onclick="abrirVentana('${pageContext.servletContext.contextPath}/Roles?pag_number=${pag.getNextPage()}')">&gt;</button>
                </div>
            </div>
           <div class="tablas">
                ${tabla}
