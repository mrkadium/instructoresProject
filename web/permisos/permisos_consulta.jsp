        ...
        <!--<div class="conf">-->
            ...
            <div class="results">
                ...
                <div class="results__pagination">
                    <p>Página</p>
                    <button class="prev" onclick="pageChange('${pageContext.servletContext.contextPath}/Permisos?pag_number=${pag.getPrevPage()}')">&lt;</button>
                    <span>${pag.getCurrentPage()}/${pag.getTotalPages()}</span>
                    <button class="next" onclick="pageChange('${pageContext.servletContext.contextPath}/Permisos?pag_number=${pag.getNextPage()}')">&gt;</button>
                </div>
            </div>
            <div class="tablas">
                ${tabla}
